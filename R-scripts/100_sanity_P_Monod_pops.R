...
# Rerunning populations Monods (phosphorous) with the new growth data
...
write.csv(summary.df, "data-processed/210_Monod_phosphorous_pops_estimates.csv") # Save summary table
write.csv(fit.df, "data-processed/211_Monod_phosphorous_pops_fits.csv") # Save model fit summary table
