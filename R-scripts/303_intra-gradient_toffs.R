...
# Creating Figure 2, a final version
...
summary(q50, se = "boot", R = 1000) # -1.30929, p 0.00048
summary(q75, se = "boot", R = 1000) # -1.51601, p 0.00000
summary(q90, se = "boot", R = 1000) # -1.56688, p 0.00000
...
summary(q50, se = "boot", R = 1000) # -2.09384, p 0.00000
summary(q75, se = "boot", R = 1000) # -1.84681, p 0.00000
summary(q90, se = "boot", R = 1000) # -1.78806, p 0.00000
...
mean(null.df$a.emp.n >= a.emp) # p-value 0.029
...
summary(q50, se = "boot", R = 1000) # 0.06594, p 0.00083
summary(q75, se = "boot", R = 1000) # -0.02014, p 0.64839
summary(q90, se = "boot", R = 1000) # -0.10849, p 0.24016
...
summary(q50, se = "boot", R = 1000) # -0.59729, p 0.00231
summary(q75, se = "boot", R = 1000) # -0.47492, p 0.00132
summary(q90, se = "boot", R = 1000) # -0.66280, p 0.02706
...
mean(null.df$a.emp.n >= a.emp) # p-value 0.750
...
summary(q50, se = "boot", R = 1000) # 0.21275, p 0.16877
summary(q75, se = "boot", R = 1000) # -0.14507, p 0.60897
summary(q90, se = "boot", R = 1000) # -0.22556, p 0.52271
...
mean(null.df3$a.emp.n >= a.emp) # p-value 0.25

q50  <- rq(z.y ~ z.x, tau = 0.50, data = df.filt3) 
q75  <- rq(z.y ~ z.x, tau = 0.75, data = df.filt3) 
q90  <- rq(z.y ~ z.x, tau = 0.90, data = df.filt3)  

summary(q50, se = "boot", R = 1000) # -1.68996, p 0.00022
summary(q75, se = "boot", R = 1000) # -1.80056, p 0.00353
summary(q90, se = "boot", R = 1000) # -1.84727, p 0.01185
...
plot(z.y ~ z.x, data= df.filt) # do we need to exclude any points?
df.filt <- df.filt[df.filt$z.y < 20,] # Yes, there is one wild data point that needs to be removed. 
...
summary(q50, se = "boot", R = 1000) # -1.32392, p 0.01501
summary(q75, se = "boot", R = 1000) # -3.34144, p 0.02282
summary(q90, se = "boot", R = 1000) # -6.25954, p 0.00057
...
summary(q50, se = "boot", R = 1000) # -9.00835, p 0.00000
summary(q75, se = "boot", R = 1000) # -10.7756, p 0.00000
summary(q90, se = "boot", R = 1000) # -9.81330, p 0.00001
...
summary(q50, se = "boot", R = 1000) # -1.46112, p 0.00000
summary(q75, se = "boot", R = 1000) # 1.49810, p 0.50470
summary(q90, se = "boot", R = 1000) # -0.85120, p 0.66744
...
summary(q50, se = "boot", R = 1000) # -10.82445, p 0.00000
summary(q75, se = "boot", R = 1000) # -5.58505, p 0.19204
summary(q90, se = "boot", R = 1000) # -9.97692, p 0.00050
...
ggsave("figures/103_fig_2_intra-gradient_tradeoffs.jpeg", grad_toffs, width = 8, height = 12)
...
ggsave("figures/103_fig_2_intra-gradient_tradeoffs_v2.jpeg", grad_toffs2, width = 8, height = 12)
...
ggsave("figures/104_fig_s4_intra-gradient_tradeoffs_qr.jpeg", qr_toffs, width = 8, height = 12)
...
ggsave("figures/104_fig_s4_intra-gradient_tradeoffs_qr_v2.jpeg", qr_toffs2, width = 8, height = 12)
