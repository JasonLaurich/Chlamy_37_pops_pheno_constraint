...
ggsave("figures/44_fig_5_inter-gradient_toffs.jpeg", full_toffs, width = 15, height = 15)
...
ggsave("figures/45_suppfig_inter-gradient_qrs.jpeg", full_qrs, width = 15, height = 15)
...
mean(null.df$a.emp.n >= a.emp) # p-value 0.525
...
mean(null.df2$a.emp.n >= a.emp) # p-value 0.204
...
summary(q50, se = "boot", R = 1000) # -0.00001, p 0.54142
summary(q75, se = "boot", R = 1000) # 0.00003, p 0.42901
summary(q90, se = "boot", R = 1000) # 0.00005, p 0.26114
...
mean(null.df$a.emp.n >= a.emp) # p-value 0.742
...
mean(null.df2$a.emp.n >= a.emp) # p-value 0.252
...
summary(q50, se = "boot", R = 1000) # 0.00004, p 0.60951
summary(q75, se = "boot", R = 1000) # 0.00015, p 0.31347
summary(q90, se = "boot", R = 1000) # 0.00018, p 0.70872
