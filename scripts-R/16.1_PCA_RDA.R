...
ggsave("figures-supplemental/04.1_fig_s4_PCA.jpeg", pca_plot_arrows, width = 12, height = 9)
...
ggsave("figures-supplemental/12.1_fig_s12_rdas.jpeg", rdas, width = 10, height = 6.5) # PDF was rendering weird
