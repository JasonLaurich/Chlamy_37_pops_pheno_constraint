...
# Inputs: in processed-data : 05_nitrogen_rfus_time.csv
# Outputs: in processed-data : 06_nitrogen_µ_estimates.csv, 07_nitrogen_monod_summary.csv, 08_nitrogen_monod_fits.csv
...
df <- read_csv("processed-data/05_nitrogen_rfus_time.csv")
...
write.csv(df.µ, "processed-data/06_nitrogen_µ_estimates.csv",
...
write.csv(summary.df, "processed-data/07_nitrogen_monod_summary.csv",
          row.names = FALSE) # 148 measurements

write.csv(fit.df, "processed-data/08_nitrogen_monod_fits.csv",
          row.names = FALSE) # 148 measurements
