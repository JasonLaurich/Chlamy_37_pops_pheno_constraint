...
# Inputs: 34_Bestion_2018_raw_data.csv, 64_Bestion_2018_TPCs.csv,
  # 35_Levasseur2025_p_rawdata.csv, 59_Levasseur_2025_TPCs.csv

# Outputs: in processed-data : 51_Bestion_2018_phos_monods.csv, 52_Bestion_2018_phos_monods_fits.csv, 
  # 53_Levasseur_2025_µ_estimates_phosphorous.csv, 54_Levasseur_2025_phos_monods.csv, 55_Levasseur_2025_phos_monods_fits.csv
...
df.b.t <- read.csv("processed-data/64_Bestion_2018_TPCs.csv") # Raw data file
head(df.b.t)
...
write.csv(bestion.summ.df, "processed-data/51_Bestion_2018_phos_monods.csv") # Bestion_2018 summary table
write.csv(fit.df, "processed-data/52_Bestion_2018_phos_monods_fits.csv") # Save model fit summary table
...
write.csv(df.r.exp.p, "processed-data/53_Levasseur_2025_µ_estimates_phosphorous.csv") # let's save the file.

###### Fit Monod curves ######

df.lv.raw <- read.csv("processed-data/53_Levasseur_2025_µ_estimates_phosphorous.csv") # Raw data file
...
write.csv(levasseur.summ.df, "processed-data/54_Levasseur_2025_phos_monods.csv") # Levasseur_2025 summary table
write.csv(fit.df, "processed-data/55_Levasseur_2025_phos_monods_fits.csv") # Save model fit summary table