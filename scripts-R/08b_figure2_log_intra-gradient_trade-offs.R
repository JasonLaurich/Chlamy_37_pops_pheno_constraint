...
# updated for re-submission on August 16th with correlational approach in the palce of quantile regressions.
...
# Outputs: figures-misc/01_fig_r1_log_intra-gradient_tradeoffs.jpeg
...
ggsave("figures-misc/01_fig_r1_log_intra-gradient_tradeoffs.jpeg", qp_toffs, width = 5.5, height = 8.25)
