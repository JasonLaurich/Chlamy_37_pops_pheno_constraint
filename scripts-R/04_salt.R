...
# Inputs: in processed-data : 13_salt_rfus_time.csv
# Outputs: in processed-data : 14_salt_µ_estimates.csv, 15_salt_tol_summary.csv, 16_salt_tol_fits.csv
...
df <- read_csv("processed-data/13_salt_rfus_time.csv")
...
write.csv(df.µ, "processed-data/14_salt_µ_estimates.csv",
...
write.csv(summary.df, "processed-data/15_salt_tol_summary.csv",
          row.names = FALSE) # 37 measurements

write.csv(fit.df, "processed-data/16_salt_tol_fits.csv",
          row.names = FALSE) # 37 measurements
