...
# Outputs:
#   processed-data/07.5_sensitivity_pvalues.csv         (long-format results)
#   processed-data/07.5_sensitivity_grid_table.csv      (grid table for supplement)
#   figures-supplemental/07.5_sensitivity_plots/[id]_sensitivity.jpeg  (15 plots)
...
write.csv(results_df, "processed-data/07.5_sensitivity_pvalues.csv", row.names = FALSE) # Save long-format results

# Per-panel P-value plots ----------------------------------------------------

results_df <- read.csv("processed-data/07.5_sensitivity_pvalues.csv")
...
ggsave("figures-supplemental/07.5_sensitivity_combined.jpeg",
       plot = combined, width = 13, height = 13, dpi = 200)
cat("Combined 5x5 grid saved to figures-supplemental/07.5_sensitivity_combined.jpeg\n")
...
write.csv(grid_table, "processed-data/07.5_sensitivity_grid_table.csv", row.names = FALSE)
cat("Grid table saved to processed-data/07.5_sensitivity_grid_table.csv\n")
