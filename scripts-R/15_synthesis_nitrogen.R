...
# Inputs: 30_Lewington-Pearce_2019_raw_data.csv, 62_Lewington_2019_TPCs.csv,
  # 33_Levasseur2025_n_rawdata.csv, 59_Levasseur_2025_TPCs.csv

# Outputs: in processed-data : 45_Lewington-Pearce_2019_µ_estimates_nitrogen.csv, 46_Lewington_2019_nit_monods.csv, 47_Lewington_2019_nit_monods_fits.csv,
  #  48_Levasseur_2025_µ_estimates_nitrogen.csv, 49_Levasseur_2025_nit_monods.csv, 50_Levasseur_2025_nit_monods_fits.csv
...
###### Calculate µ across nitrogen levels ######
...
write.csv(df.r.exp.n, "processed-data/45_Lewington-Pearce_2019_µ_estimates_nitrogen.csv") # let's save the file.

df.l.raw <- read.csv("processed-data/45_Lewington-Pearce_2019_µ_estimates_nitrogen.csv") # Raw data file
...
write.csv(lewington.summ.df, "processed-data/46_Lewington_2019_nit_monods.csv") # Lewington_2019 summary table
write.csv(fit.df, "processed-data/47_Lewington_2019_nit_monods_fits.csv") # Save model fit summary table
...
###### Estimate µ across nitrogen levels ######
...
write.csv(df.r.exp.n, "processed-data/48_Levasseur_2025_µ_estimates_nitrogen.csv") # let's save the file.

###### Fit Monod curves ######

df.lv.raw <- read.csv("processed-data/48_Levasseur_2025_µ_estimates_nitrogen.csv") # Raw data file
...
write.csv(levasseur.summ.df, "processed-data/49_Levasseur_2025_nit_monods.csv") # Levasseur_2025 summary table
write.csv(fit.df, "processed-data/50_Levasseur_2025_nit_monods_fits.csv") # Save model fit summary table