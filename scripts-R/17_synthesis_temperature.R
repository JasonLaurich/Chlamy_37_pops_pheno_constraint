...
# Inputs: 30_Lewington-Pearce_2019_raw_data.csv, 31_Edwards_2016_raw_data.csv,
  # 32_Levasseur2025_l_rawdata.csv, 33_Levasseur2025_n_rawdata.csv, 35_Levasseur2025_p_rawdata.csv,
  # 34_Bestion_2018_raw_data.csv, 36_Thomas_2012_raw_data.csv

# Outputs: in processed-data : 56_Edwards_2016_TPCs.csv, 57_Edwards_2016_TPCs_fits.csv,
  # 58_Levasseur_2025_µ_estimates_temp.csv, 59_Levasseur_2025_TPCs.csv, 60_Levasseur_2025_TPCs_fits.csv.
  # 61_Lewington-Pearce_2019_µ_estimates_temp.csv, 62_Lewington_2019_TPCs.csv, 63_Lewington_2019_TPCs_fits.csv,
  # 64_Bestion_2018_TPCs.csv, 65_Bestion_2018_TPCs_fits.csv,  
  # 66_Thomas_2012_TPCs.csv, 67_Thomas_2012_TPCs_fits.csv
...
df.t.raw <- read.csv('processed-data/36_Thomas_2012_raw_data.csv') # Thomas raw data
head(df.t.raw)
...
write.csv(thomas.summ.df, "processed-data/66_Thomas_2012_TPCs.csv") # Save Thomas 2012 summary table
write.csv(fit.df, "processed-data/67_Thomas_2012_TPCs_fits.csv") # Save model fit summary table

# Bestion 2018 ------------------------------------------------------------

###### Load the data ######

df.b.raw <- read.csv("processed-data/34_Bestion_2018_raw_data.csv") # Raw growth data
head(df.b.raw)
...
write.csv(bestion.summ.df, "processed-data/64_Bestion_2018_TPCs.csv") # Save Bestion_2018 summary table
write.csv(fit.df, "processed-data/65_Bestion_2018_TPCs_fits.csv") # Save model fit summary table

# Lewington-Pearce 2019 ------------------------------------------------------------

###### Load the data ######

df <- read.csv("processed-data/30_Lewington-Pearce_2019_raw_data.csv") # Raw data file
head(df)
str(df)
...
write.csv(df.r.exp, "processed-data/61_Lewington-Pearce_2019_µ_estimates_temp.csv") # let's save the file.

# Can start from here

df.l.raw <- read.csv("processed-data/61_Lewington-Pearce_2019_µ_estimates_temp.csv") # growth data
head(df.l.raw)
...
write.csv(lewington.summ.df, "processed-data/62_Lewington_2019_TPCs.csv") # Lewington_2019 summary table
write.csv(fit.df, "processed-data/63_Lewington_2019_TPCs_fits.csv") # Save model fit summary table

# Edwards 2016 ------------------------------------------------------------

###### Load the data ######

df.e.raw <- read.csv("processed-data/31_Edwards_2016_raw_data.csv") # Raw data file
head(df.e.raw)
...
write.csv(edwards.summ.df, "processed-data/56_Edwards_2016_TPCs.csv") # Edwards_2016 summary table
write.csv(fit.df, "processed-data/57_Edwards_2016_TPCs_fits.csv") # Save model fit summary table

# Levasseur 2025 ------------------------------------------------------------

###### Load the data ######

df.l <- read.csv("processed-data/32_Levasseur2025_l_rawdata.csv") # Raw data file
head(df.l)
str(df.l)
...
df.n <- read.csv("processed-data/33_Levasseur2025_n_rawdata.csv") # Raw data file
head(df.n)
str(df.n)
...
df.p <- read.csv("processed-data/35_Levasseur2025_p_rawdata.csv") # Raw data file
head(df.p)
str(df.p)
...
write.csv(df.r.exp, "processed-data/58_Levasseur_2025_µ_estimates_temp.csv") # let's save the file.
...
write.csv(levasseur.t.summ.df, "processed-data/59_Levasseur_2025_TPCs.csv") # Save Levasseur 2025 TPC summary table
write.csv(fit.df, "processed-data/60_Levasseur_2025_TPCs_fits.csv") # Save model fit summary table
