...
# Inputs: 34_Lewington-Pearce_2019_raw_data.csv, 36_Lewington_2019_TPCs.csv, 42_Levasseur2025_n_rawdata.csv,
  # 45_Levasseur_2025_TPCs.csv
# Outputs: in processed-data : 55_Lewington-Pearce_2019_µ_estimates_nitrogen.csv, 56_Lewington_2019_nit_monods.csv, 
  # 57_Lewington_2019_nit_monods_fits.csv, 58_Levasseur_2025_µ_estimates_nitrogen.csv, 59_Levasseur_2025_nit_monods.csv
  # 60_Levasseur_2025_nit_monods_fits.csv
...
write.csv(df.r.exp.n, "processed-data/55_Lewington-Pearce_2019_µ_estimates_nitrogen.csv") # let's save the file.

df.l.raw <- read.csv("processed-data/55_Lewington-Pearce_2019_µ_estimates_nitrogen.csv") # Raw data file
...
write.csv(lewington.summ.df, "processed-data/56_Lewington_2019_nit_monods.csv") # Lewington_2019 summary table
write.csv(fit.df, "processed-data/57_Lewington_2019_nit_monods_fits.csv") # Save model fit summary table
...
write.csv(df.r.exp.n, "processed-data/58_Levasseur_2025_µ_estimates_nitrogen.csv") # let's save the file.

###### Fit Monod curves ######

df.lv.raw <- read.csv("processed-data/58_Levasseur_2025_µ_estimates_nitrogen.csv") # Raw data file
...
write.csv(levasseur.summ.df, "processed-data/59_Levasseur_2025_nit_monods.csv") # Levasseur_2025 summary table
write.csv(fit.df, "processed-data/60_Levasseur_2025_nit_monods_fits.csv") # Save model fit summary table