...
# updated for re-submission on August 16th, 2026. 
...
# It generates Figure 3 and the distance to PF supplemental fig (S4).

# with spearman corrs and rma

# Inputs: 27_summary_table.csv
# Outputs: figures-main/03_fig_3_inter-gradient_toffs.pdf
#          figures-supplemental/04_fig_s4_dist_to_pf.pdf
...
par.res.1 <- par_frt(df.filt, xvar = "z.x", yvar = "z.y")
# fit <- scam(z.y ~ s(z.x, bs = "mpd", k = min(6, nrow(par.res.1))), data = par.res.1) # fails (not enough points)
...
ggsave("figures-main/03_fig_3_inter-gradient_toffs.pdf", full_qps, width = 11, height = 11)
...
ggsave("figures-supplemental/04_fig_s4_dist_to_pf.pdf", full_dist, width = 13.5, height = 13.5)
