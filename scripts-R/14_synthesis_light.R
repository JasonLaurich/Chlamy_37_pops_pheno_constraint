...
# NOTE: must run script 17_synthesis_temperature.R or have its outputs saved in the appropriate folder before this script will run.
...
# Inputs: 30_Lewington-Pearce_2019_raw_data.csv, 62_Lewington_2019_TPCs.csv,
  # 31_Edwards_2016_raw_data.csv, 56_Edwards_2016_TPCs.csv,  
  # 32_Levasseur2025_l_rawdata.csv, 59_Levasseur_2025_TPCs.csv,         

# Outputs: in processed-data : 37_Edwards_2016_light_monods.csv, 38_Edwards_2016_light_monods_fits.csv, 
  # 39_Lewington-Pearce_2019_µ_estimates_light.csv, 40_Lewington_2019_light_monods.csv, 41_Lewington_2019_light_monods_fits.csv,
  # 42_Levasseur_2025_µ_estimates_light.csv, 43_Levasseur_2025_light_monods.csv, 44_Levasseur_2025_light_monods_fits.csv
...
df.e.t <- read.csv("processed-data/56_Edwards_2016_TPCs.csv") # Raw data file
...
write.csv(edwards.summ.df, "processed-data/37_Edwards_2016_light_monods.csv") # Edwards_2016 summary table
write.csv(fit.df, "processed-data/38_Edwards_2016_light_monods_fits.csv") # Save model fit summary table
...
write.csv(df.r.exp.l, "processed-data/39_Lewington-Pearce_2019_µ_estimates_light.csv") # let's save the file.

df.l.raw <- read.csv("processed-data/39_Lewington-Pearce_2019_µ_estimates_light.csv") # Raw data file
...
df.l.t <- read.csv("processed-data/62_Lewington_2019_TPCs.csv") # Raw data file
...
write.csv(lewington.summ.df, "processed-data/40_Lewington_2019_light_monods.csv") # Lewington_2019 summary table
write.csv(fit.df, "processed-data/41_Lewington_2019_light_monods_fits.csv") # Save model fit summary table
...
write.csv(df.r.exp.l, "processed-data/42_Levasseur_2025_µ_estimates_light.csv") # let's save the file.

df.lv.raw <- read.csv("processed-data/42_Levasseur_2025_µ_estimates_light.csv") # Raw data file
...
df.lv.t <- read.csv("processed-data/59_Levasseur_2025_TPCs.csv") # Raw data file
...
write.csv(levasseur.summ.df, "processed-data/43_Levasseur_2025_light_monods.csv") # Levasseur_2025 summary table
write.csv(fit.df, "processed-data/44_Levasseur_2025_light_monods_fits.csv") # Save model fit summary table