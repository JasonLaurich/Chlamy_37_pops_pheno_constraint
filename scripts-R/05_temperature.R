...
# Inputs: in processed-data : 17_temperature_rfus.time.csv
# Outputs: in processed-data : 18_temperature_µ_estimates.csv, 19_temperature_nls_rTPC_comparison_AICcs.csv, 20_temperature_TPC_summary.csv, 21_temperature_TPC_fits.csv
...
df <- read_csv("processed-data/17_temperature_rfus_time.csv")
...
write.csv(df.µ, "processed-data/18_temperature_µ_estimates.csv",
...
write.csv(aicc_df, "processed-data/19_temperature_nls_rTPC_comparison_AICcs.csv") # Save model comparison data
...
for (i in rep.ids[1:length(rep.ids)]) { # For all replicates, here starting at 1, but could account for multiple coding sessions to generate all of the objects
...
write.csv(summary.df, "processed-data/20_temperature_TPC_summary.csv",
          row.names = FALSE) # 148 measurements

write.csv(fit.df, "processed-data/21_temperature_TPC_fits.csv",
          row.names = FALSE) # 148 measurements
