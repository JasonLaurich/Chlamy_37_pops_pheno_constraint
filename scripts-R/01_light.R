...
# re-visited Aug 16th, 2026 for re-submission
...
# Inputs: in processed-data : 01_light_rfus_time.csv
# Outputs: in processed-data : 02_light_µ_estimates.csv, 03_light_monod_summary.csv, 04_light_monod_fits.csv
...
df <- read_csv("processed-data/01_light_rfus_time.csv")
...
write.csv(df.µ, "processed-data/02_light_µ_estimates.csv",
...
write.csv(summary.df, "processed-data/03_light_monod_summary.csv",
          row.names = FALSE) # 148 measurements

write.csv(fit.df, "processed-data/04_light_monod_fits.csv",
          row.names = FALSE) # 148 measurements
